...
2. [Construction of $L^p$](#LpSpace): Holder's inequality, 
    Minkowski inequality, dual of $L^p$. 
...
2. The convexity of $x\mapsto |x|^{p>1}$ and monotonicity in $p$ 
    ...
    - Minkowski's inequality (proposition \@ref(thm:minkowskiInequality)) 
