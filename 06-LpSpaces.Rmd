...
A metric is complete if every Cauchy sequence 
in the space converges. A Banach space is 
a complete normed metric space. 
:::

:::{.proposition name="connection between complete and closed spaces"}
...
:::{.theorem name="Baire's theorem"}

a. A complete vector space is not the countable union 
    of closed subsets with empty interior. 
b. The countable intersection of dense open sets of a complete 
    metric space is nonempty. 
:::
...
:::{.theorem name="bounded inverse theorem"}
Placeholder. 
:::
...
<details>
<summary>Proof</summary>
Linearity follows from definition. 
For nonnegativity, 
$\|f\|_p = 0 \iff \|f^p\|_1 = 0 \iff f=0$, where the second and 
third equalities are to be understood as $\mu$-a.e. 
Triangle inequality is proved by Minkowski's inequality \@ref(thm:Minkowski). 
</details>
...
:::{.proposition name="variational formula for p-norm"}
...
:::{.theorem name="Lp is a Banach space"}
