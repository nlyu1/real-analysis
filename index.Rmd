...
4. [Iterated integrals](#iteratedIntegrals}): uniqueness of product measure 
    ...
    - Lieb and Loss, chapter 1. 
5. [Banach spaces](#banachSpaces): Infinite-dimensional normed vector spaces 
    and Hahn-Banach theorem; Baire's theorem and other Banach theorems. 
    functionals, Hahn-Banach theorem. 
    - Axler, Chapter 6. 
...
4. <u>Hahn-Banach, hyperplane separation</u> theorems:
    bounded linear functionals on a normed vector space 
    can be extended without increasing its norm. 
4. <u>Fubini's theorem</u>
5. <u>Baire's theorem</u>
...
4. Using the monotone class theorem (example theorem \@ref(thm:uniqueMeasure)): 
...
2. Proof for $\sigma$-finite case in proposition \@ref(prp:variationalPnorm). 
3. Proof for the dual of $L^p$ space. 

Optional: 

1. Product measure and Fubini. 
2. Complete section on Banach spaces. 
